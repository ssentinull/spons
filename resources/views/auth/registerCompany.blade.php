...
@section('content')
    <div class="cardawal">
        ...
        <div class="regisc">
                                            ...
                                            <input type="date"  style="margin-left:117px;" placeholder="Established in" name="established_in" required><br><br>
                                            ...
                                            <label style=" margin-left:340px;"  for="description">Description<br></label><br>

                                            <input type="password" placeholder="Password" name="password" required>
                                           
                                            <br><br> <label for="password" >Confirm Password</label> 
                                            <textarea type="text" style="width:300px; margin-top:-200px; margin-left:250px; border-radius: 7px; border-color:#0E8C7F; color:#0E8C7F; " placeholder="    Description" name="description" required></textarea><br>
        ...
        <div class="data">
        <button style="background-color:#0E8C7F;color:#fff; margin-top:-2px; font-size: 20px;">Sign Up</button>
        </form>
